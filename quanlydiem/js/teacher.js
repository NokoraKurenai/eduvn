...
function initializeEventListeners() {
    ...
    // Nhập điểm
    loadScoresBtn.addEventListener('click', updateScoreInputTable);
...
function updateDashboardStats() {
    ...
    totalSubjectsCount.textContent = currentTeacherSubjects.length;
...
function updateScoreInputTable() {
    ...
    let tableHTML = `
        <div class="score-header">
            <h4>Nhập điểm ${typeName} môn ${subjectName} - Lớp ${selectedClass}</h4>
            <p class="score-instruction">Nhập điểm từ 0 đến 10. Điểm sẽ được lưu tự động khi bạn nhập.</p>
        </div>
    ...
    tableHTML += `
        ...
        <div class="score-actions">
            <button id="save-all-scores" class="btn btn-success">
    ...
    scoreInputSection.innerHTML = tableHTML;
